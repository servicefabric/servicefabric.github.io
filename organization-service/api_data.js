define({ "api": [
  {
    "type": "ServiceMethod: addApiKey",
    "url": "/organizations/addApiKey",
    "title": "addApiKey",
    "name": "AddApiKey",
    "group": "ApiKey",
    ...
    "description": "<p>This operation enables only organization managers <b>(Owner | Admin)</b> to create the API keys (token) for the relevant organization and further to be used (write and read ability) by potential users of the <a href=\"http://scalecube.io/configuration-service/index.html\">Configuration service</a> according to appropriate permission level. Each API key got the unique name which couldn't be duplicated. Thus Owners could issue the API keys with all accessible roles but the Admins are restricted by the &quot;Admin&quot; or &quot;Member&quot; role API keys issuing.</p> <blockquote> <p>Note: this method returns all organization info thus API keys with: <br>-all accessible permission levels (&quot;Owner&quot; | &quot;Admin&quot; | &quot;Member&quot;) will be returned only for the related Organization Owner <br>-&quot;Admin&quot; | &quot;Member&quot; permission levels will be returned only for the related Organization Admin <br>-&quot;Member&quot; permission level will be returned only for the related Organization Member</p> </blockquote>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "ServiceMethod: deleteApiKey",
    "url": "/organizations/deleteApiKey",
    "title": "deleteApiKey",
    "name": "DeleteApiKey",
    "group": "ApiKey",
    "version": "2.1.7-SNAPSHOT",
    ...
    "description": "<p>This operation enables only organization managers <b>(Owner | Admin)</b> to delete the API keys (token) from the relevant organization. Thus write or read rights will be revoked from the consumers of the Configuration service who was using the related terminated API key.</p> <blockquote> <p>Note: this method returns all organization info thus API keys with: <br>-all accessible permission levels (&quot;Owner&quot; | &quot;Admin&quot; | &quot;Member&quot;) will be returned only for the related Organization Owner <br>-&quot;Admin&quot; | &quot;Member&quot; permission levels will be returned only for the related Organization Admin <br>-&quot;Member&quot; permission level will be returned only for the related Organization Member</p> </blockquote>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "field",
            "description": "<p>Permission denied for specified organization member either organization outsider</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "description": "<p>This operation enables only organization managers <b>(Owner | Admin)</b> to delete the API keys (token) from the relevant organization.</p> <blockquote> <p>Note: this method returns all organization info thus API keys with: <br>-all accessible permission levels (&quot;Owner&quot; | &quot;Admin&quot; | &quot;Member&quot;) will be returned only for the related Organization Owner <br>-&quot;Admin&quot; | &quot;Member&quot; permission levels will be returned only for the related Organization Admin <br>-&quot;Member&quot; permission level will be returned only for the related Organization Member</p> </blockquote>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "ServiceMethod: getMyOrganizations",
    "url": "/organizations/getMyOrganizations",
    ...
    "description": "<p>This operation enables each organization <b>member</b> to get the list of all relevant organizations (full info) which the member was invited.</p> <blockquote> <p>Note: this method returns all organization info thus API keys with: <br>-all accessible permission levels (&quot;Owner&quot; | &quot;Admin&quot; | &quot;Member&quot;) will be returned only for the related Organization Owner <br>-&quot;Admin&quot; | &quot;Member&quot; permission levels will be returned only for the related Organization Admin <br>-&quot;Member&quot; permission level will be returned only for the related Organization Member</p> </blockquote>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "organizations",
            "description": "<p>List of all Organizations (Array of objects) which the member was invited</p>"
          },
          {
            "group": "Success 200",
            "type": "Object[]",
            "optional": false,
            "field": "organizations.apiKeys",
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "field",
            "description": "<p>user isn't the manager either outsider of the specified organization</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "description": "<p>This operation enables only organization managers <b>(Owner | Admin)</b> to invite a valid user (which client id issued by relevant authority - <a href=\"https://manage.auth0.com/\">Auth0</a>) to step into relevant organization with relevant member's role (permission level).</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "role",
            "description": "<p>Specified permission level (roles: Owner/Admin/Member) granted for the organization members</p>"
          }
        ]
      }
    },
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "field",
            "description": "<p>Invalid role for specified organization member is applied</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "ServiceMethod: updateMemberRole",
    "url": "/organizations/updateMemberRole",
  ...
  {
    "type": "ServiceMethod: createOrganization",
    ...
    "description": "<p>This operation enables any user with valid <a href=\"https://manage.auth0.com/\">Token</a> to create the specific organization and store its information (metadata). Organization name can only contain characters in range A-Z, a-z, 0-9 as well as underscore, period, dash &amp; percent.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "field",
            "description": "<p>Duplication of the Organization name</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "ServiceMethod: deleteOrganization",
    ...
    "description": "<p>This operation enables only <b>Owners</b> to delete relevant organization. <br>All relevant API keys issued for organization also deleted thus become invalid after specific period of time is left upon this operation was done.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "description": "<p>This operation enables <b>all members</b> of the relevant organization to get the full organization information.</p> <blockquote> <p>Note: this method returns all organization info thus API keys with: <br>-all accessible permission levels (&quot;Owner&quot; | &quot;Admin&quot; | &quot;Member&quot;) will be returned only for the related Organization Owner <br>-&quot;Admin&quot; | &quot;Member&quot; permission levels will be returned only for the related Organization Admin <br>-&quot;Member&quot; permission level will be returned only for the related Organization Member</p> </blockquote>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "description": "<p>This operation enables each organization <b>member</b> to step-out (leave) from the relevant organization. <br>Nevertheless at least one Owner (origin or granted one) should be persisted in the organization.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "description": "<p>This operation enables only organization managers <b>(Owner | Admin)</b> to update (edit) the specific organization information (name or email) optionally.</p> <blockquote> <p>Note: this method returns all organization info thus API keys with: <br>-all accessible permission levels (&quot;Owner&quot; | &quot;Admin&quot; | &quot;Member&quot;) will be returned only for the related Organization Owner <br>-&quot;Admin&quot; | &quot;Member&quot; permission levels will be returned only for the related Organization Admin <br>-&quot;Member&quot; permission level will be returned only for the related Organization Member</p> </blockquote>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
